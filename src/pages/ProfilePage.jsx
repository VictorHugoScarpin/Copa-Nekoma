        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px' }}>
              <img src="/neo.png" alt="Neko" style={{ height: '92px', filter: 'drop-shadow(0 0 8px rgba(232,184,75,0.4))', opacity: 0.85 }} onError={e => { e.target.style.display = 'none' }} />
              <img src="/hugos.png" alt="Hugos" style={{ height: '98px', filter: 'drop-shadow(0 0 8px rgba(232,184,75,0.4))', opacity: 0.85 }} onError={e => { e.target.style.display = 'none' }} />
            </div>
